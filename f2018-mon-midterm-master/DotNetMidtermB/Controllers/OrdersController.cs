...
namespace DotNetMidtermB.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,SizeId,Quantity,FirstName,LastName")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,SizeId,Quantity,FirstName,LastName")] Order order)
        {
            if (ModelState.IsValid)
            {
